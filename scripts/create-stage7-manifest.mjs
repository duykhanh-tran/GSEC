...
const outputPath = join(projectRoot, 'checkpoints', 'stage-7', 'manifest.json')
...
const files = [
  ...
  'STAGE-7-REPORT.md', 'tsconfig.app.json', 'tsconfig.json', 'tsconfig.node.json',
  'vite.config.ts', 'vitest.config.ts', 'checkpoints/stage-7/README.md',
  'checkpoints/stage-7/validation.log',
]
