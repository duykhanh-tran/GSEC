...
const outputPath = join(projectRoot, 'checkpoints', 'stage-8', 'manifest.json')
...
const files = [
  ...
  'STAGE-7-REPORT.md', 'STAGE-8-REPORT.md', 'tsconfig.app.json', 'tsconfig.json',
  'tsconfig.node.json', 'vite.config.ts', 'vitest.config.ts',
  'checkpoints/stage-8/README.md', 'checkpoints/stage-8/validation.log',
]
